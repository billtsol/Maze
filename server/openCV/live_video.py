# Live_video.py
# Ο κώδικας αυτός επιτρέπει τη λήψη και την εμφάνιση live βίντεο από ένα IP stream της ESP32-CAM
# χρησιμοποιώντας OpenCV και NumPy. Αρχικά, η κάμερα συνδέεται μέσω ενός URL που παραπέμπει
# στη ροή βίντεο της κάμερας. Σε κάθε επανάληψη, το πρόγραμμα κάνει αίτηση για λήψη εικόνας
# μέσω του URL και μετατρέπει τα δεδομένα εικόνας σε μορφή που μπορεί να αναγνωρίσει το OpenCV.
# Η ροή live βίντεο εμφανίζεται σε ένα παράθυρο με τίτλο "live Video"
